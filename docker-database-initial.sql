...
VALUES ('be89dede-00f2-48eb-880b-c9b728ce5bfc', 'student1', 'student1@test.com', '$2a$10$kXz14cSQ4CuM8ev7MKWtQu1/4Ny7v/ic5xuQxgwZzh.x9ZHLuxOM2', 'STUDENT', NOW()),
...
INSERT INTO public.locations (name, street, number, neighborhood, city, state, zip_code, campus, reference_point, capacity)
VALUES
    ('Laboratório de Informática 01', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Central', 'Prédio Principal', 40),
    ('Sala de Aula 101', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Norte', 'Bloco A', 50),
    ('Sala de Aula 102', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Leste', 'Bloco A', 50),
    ('Sala de Aula 103', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Sul', 'Bloco A', 50),
    ('Sala de Aula 104', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Oeste', 'Bloco A', 50),
    ('Sala de Aula 201', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Alfa', 'Bloco B', 60),
    ('Sala de Aula 202', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Beta', 'Bloco B', 60),
    ('Laboratório de Química', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Gama', 'Prédio de Ciências', 30),
    ('Laboratório de Física', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Central', 'Prédio de Ciências', 30),
    ('Laboratório de Biologia', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Norte', 'Prédio de Ciências', 35),
    ('Auditório Principal', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Sul', 'Térreo', 250),
    ('Mini Auditório', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Leste', 'Bloco C', 80),
    ('Biblioteca Central', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Oeste', 'Prédio Anexo', 150),
    ('Sala de Estudos 01', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Alfa', 'Dentro da Biblioteca', 20),
    ('Sala de Estudos 02', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Beta', 'Dentro da Biblioteca', 20),
    ('Sala de Reuniões Coordenação', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Gama', 'Prédio Administrativo', 15),
    ('Quadra Poliesportiva', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Central', 'Área Externa', 500),
    ('Espaço Maker', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Inovação', 'Prédio de Inovação', 45),
    ('Estúdio de Gravação', 'Rua das Flores', '123', 'Centro', 'Surubim', 'PE', '55750-000', 'Campus Surubim Criativo', 'Prédio de Comunicação', 10),
    ('Laboratório de Redes', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Norte', 'Bloco 1', 40),
    ('Laboratório de Hardware', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Leste', 'Bloco 1', 35),
    ('Sala de Aula 301', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Sul', 'Bloco 2', 55),
    ('Sala de Aula 302', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Oeste', 'Bloco 2', 55),
    ('Sala de Aula 303', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Central', 'Bloco 2', 55),
    ('Auditório Paulo Freire', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Alfa', 'Térreo', 300),
    ('Sala de Videoconferência', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Beta', 'Bloco 1', 25),
    ('Laboratório de Robótica', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Gama', 'Bloco 3', 30),
    ('Sala de Metodologias Ativas 1', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Inovação', 'Bloco 3', 40),
    ('Sala de Metodologias Ativas 2', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Criativo', 'Bloco 3', 40),
    ('Biblioteca Setorial', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Central', 'Bloco 4', 100),
    ('Laboratório de Enfermagem', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Saúde', 'Bloco Saúde', 30),
    ('Laboratório de Anatomia', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Saúde', 'Bloco Saúde', 40),
    ('Clínica Escola', 'Av. Agamenon Magalhães', 'S/N', 'Derby', 'Recife', 'PE', '52010-000', 'Campus Recife Saúde', 'Bloco Saúde', 50),
    ('Sala de Aula 401', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Leste', 'Bloco A', 60),
    ('Sala de Aula 402', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Sul', 'Bloco A', 60),
    ('Sala de Aula 403', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Oeste', 'Bloco A', 60),
    ('Laboratório de Design', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Criativo', 'Bloco B', 35),
    ('Laboratório de Moda', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Criativo', 'Bloco B', 30),
    ('Ateliê de Costura', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Criativo', 'Bloco B', 25),
    ('Sala de Desenho', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Alfa', 'Bloco B', 40),
    ('Auditório Ariano Suassuna', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Central', 'Central', 200),
    ('Laboratório de Informática 03', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Beta', 'Bloco C', 40),
    ('Laboratório de Informática 04', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Gama', 'Bloco C', 40),
    ('Sala de Reuniões Professores', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Delta', 'Administrativo', 20),
    ('Espaço de Convivência', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Central', 'Externo', 150),
    ('Laboratório de Fotografia', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Inovação', 'Bloco D', 20),
    ('Estúdio de Áudio', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Inovação', 'Bloco D', 15),
    ('Sala de Defesas', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Pós-Graduação', 'Bloco Pós', 35),
    ('Laboratório Maker Avançado', 'Rodovia BR-104', 'Km 68', 'Nova Caruaru', 'Caruaru', 'PE', '55014-000', 'Campus Caruaru Inovação', 'Inovação', 40);
